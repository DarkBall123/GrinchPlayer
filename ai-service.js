            ...
            input: [{
                ...
                content: [{
                    ...
                    text: 'Ты не собеседник и не автор реплик. Ты ранжируешь существующие аудиофразы ' +
                        ...
                        'callback, зеркалирования или абсурдной петли. При хамстве, угрозах, обвинениях, ' +
                        'повторном давлении или фазе escalation мат становится отдельной полезной тактикой: ' +
                        'если среди candidates есть уместные матерные записи, обязательно включай в top-5 ' +
                        'две-три разные жёсткие фразы. На спокойном приветствии и обычном уточнении мат не ' +
                        'поднимай; явный запрет сценария на мат имеет приоритет. Мат тоже не сочиняй. ' +
                        'Пять вариантов должны представлять ' +
